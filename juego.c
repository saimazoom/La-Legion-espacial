...
{		
	...
	if (fverbo==vUsar && fnombre1==nTeclado) { ACCwriteln ("Debo teclear la clave correcta en el teclado."); DONE; }
...
char proceso1_post() // Después de la descripción
{
	if (CNDat (lPuente) && !localidades_t[0].visited)
		ACCwriteln ("El ordenador de navegación está tarareando una canción.");
