...
loc_t localidades_t [] =
{
    ...
    {"Zona A1","Las monótonas estanterías repletas de contenedores blancos crean una atmósfera impersonal. Al oeste un oscuro pasillo da acceso al oeste da acceso a una sala roja.",lZonaA1, FALSE, 0x00000000},
